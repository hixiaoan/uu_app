...
import 'package:uu_app/widgets/login_animation_widget.dart';

import '../../../widgets/login_input_textfield.dart';
...
class ReigsterPage extends StatefulWidget {
  ...
  static const routerName = "/reigsterPage";
  ...
  Widget build(BuildContext context) {
   ...
   cheackReigsterData() {
    ...
    if (imoocId == null){
      ...
      showWarnToast("请输入慕课网ID");
      return;
    }

    if (orderId == null){
      showWarnToast("请输入订单后四位");
      return;
    }

    if (orderId == null){
      showWarnToast("请输入订单号");
      return;
    }
