...
import 'package:uu_app/modules/home_module/child_pages/author_page.dart';
...
import 'package:uu_app/widgets/video_play_util/video_view_widget.dart';
import '../../../web_socket/barrage_inpunt.dart';
import '../../../web_socket/barrage_widget.dart';
...
class VideoDetailPage extends StatefulWidget {
  ...
  static const routerName = '/videoDetailPage';

  String videoId;
  VideoDetailPage({Key? key, required this.videoId}) : super(key: key);
...
class _VideoDetailPageState extends State<VideoDetailPage>  with TickerProviderStateMixin{
        ...
        children: [
          SizedBox(
            ...
            child: UUTabWidget(
                ...
                list: list,
                tabs: list.map<Tab>((e) {
                  return Tab(child: Text(e, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)));}).toList(),
        ...
        child: TabBarView(
            ...
            children: list.map<Widget>((e) {
              if (e == "简介"){
                ...
                return AuthorPage(detailModel: detailModel!,onTap: (vid){
                  widget.videoId = vid;
                  loadDetaiInfo();
                },);
              }else{
  ...
  void loadDetaiInfo()  {
     ...
     UUHomeDao
         .requestVideoDetaiData(widget.videoId)
         .then((model){
